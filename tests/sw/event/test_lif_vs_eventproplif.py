...
class TestCompareLIFVsEventPropLIF(unittest.TestCase):
    ...
    def test_single_layer_equal(self):
        ...
        self.assertIsNone(assert_array_equal(
            res_1[0].current[res_1[0].idx > 4], res_2[0].current[res_2[0].idx > 4]))
        ...
        # check gradients
        _, (grad_w_1, grad_t_1)= jax.value_and_grad(loss_fn_1, argnums=(0, 1))(
            weights_1,
            trainset[0].time[sample_idx],
            trainset[0].idx[sample_idx],
            trainset[0].current[sample_idx])
        _, (grad_w_2, grad_t_2) = jax.value_and_grad(loss_fn_2, argnums=(0, 1))(
            weights_2,
            trainset[0].time[sample_idx],
            trainset[0].idx[sample_idx],
            trainset[0].current[sample_idx])
        ...
        self.assertIsNone(assert_array_almost_equal(
            grad_t_1, grad_t_2, 1))
        self.assertIsNone(assert_array_almost_equal(
            grad_w_1[0].input, grad_w_2[0].input, 4))
        ...
        self.assertIsNone(assert_array_almost_equal(
            grad_w_1[0].input, grad_w_2[0].input, 5))
    ...
    def test_multi_layer_equal(self):
        ...
        self.assertIsNone(assert_array_equal(
            weights_1[0].input, weights_2[0].input))
        self.assertIsNone(assert_array_equal(
            weights_1[1].input, weights_2[1].input))
        ...
        # they all produce the same output
        self.assertIsNone(assert_array_equal(
            res_1[0].time[res_1[0].idx >= input_size],
            res_2[0].time[res_2[0].idx >= input_size]))

        self.assertIsNone(assert_array_equal(
            res_1[0].idx[res_1[0].idx >= input_size],
            res_2[0].idx[res_2[0].idx >= input_size]))

        self.assertIsNone(assert_array_equal(
            res_1[0].current[res_1[0].idx >= input_size],
            res_2[0].current[res_2[0].idx >= input_size]))

        self.assertIsNone(assert_array_equal(
            res_1[1].time[res_1[1].idx >= hidden_size + input_size],
            res_2[1].time[res_2[1].idx >= hidden_size + input_size]))

        self.assertIsNone(assert_array_equal(
            res_1[1].idx[res_1[1].idx > hidden_size + input_size],
            res_2[1].idx[res_2[1].idx > hidden_size + input_size]))

        self.assertIsNone(assert_array_equal(
            res_1[1].current[res_1[1].idx > hidden_size + input_size],
            res_2[1].current[res_2[1].idx > hidden_size + input_size]))
        ...
        axs[2].plot(grad_2[1].input.reshape(-1))
        axs[3].plot(np.abs(grad_1[1].input - grad_2[1].input).reshape(-1))
        ...
        self.assertIsNone(assert_array_almost_equal(
            grad_1[0].input, grad_2[0].input, 6))
        self.assertIsNone(assert_array_almost_equal(
            grad_1[1].input, grad_2[1].input, 6))
        ...
        self.assertIsNone(assert_array_almost_equal(
            grad_1[1].input, grad_2[1].input, 7))
        ...
        for i in range(10):
            ...
            loss_fn_1 = partial(loss_fn_batched, apply_fn_1)
            loss_fn_2 = partial(loss_fn_batched, apply_fn_2)
